...
from models.schedules import transformer_learning_rate_scheduler
...
def main(rank, args):
    ...
    # if config["training_params"]["lr_schedule"] == "Transformer":
    #     # Transformer LR
    #     model.scheduler = transformer_learning_rate_scheduler(
    #         optimizer=model.optimizer,
    #         dim_model=config["training_params"]["schedule_dim"],
    #         warmup_steps=config["training_params"]["warmup_steps"],
    #         K=config["training_params"]["K"])
